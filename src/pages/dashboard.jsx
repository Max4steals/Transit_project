...
export default function DashboardPage() {
    const [stats, setStats] = useState({ total: 0, ca: 0, imports: 0, exports: 0 });
    ...
    async function fetchDashboardData() {
        try {
            ...
            setStats({ total, ca, imports: importsCount, exports: exportsCount });

            // 2. Préparation des données mixtes par mois
            const months = ["Jan", "Fév", "Mar", "Avr", "Mai", "Jun", "Jul", "Août", "Sep", "Oct", "Nov", "Déc"];
            const monthlyStats = months.map((month, index) => {
                const dossiersDuMois = data.filter(d => new Date(d.created_at).getMonth() === index);
        ...
        <div className="flex h-screen bg-gray-50 font-sans text-black">
            ...
            <aside className="w-64 bg-black text-white flex flex-col">
                ...
                <nav className="flex-1 px-4 space-y-2">
                    ...
                    <NavItem label="Dashboard" to="/dashboard" active />

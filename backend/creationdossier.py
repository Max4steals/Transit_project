...
def create_dossier(data):
    ...
    c.drawString(col1 + 2*mm, y - 18*mm, str(data.get("expediteur", "")))
    c.drawString(col2 + 2*mm, y - 18*mm, str(data.get("destinataire", "")))
    c.drawString(col3 + 2*mm, y - 18*mm, str(data.get("marchandise", "")))
